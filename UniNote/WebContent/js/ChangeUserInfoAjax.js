...
function verify() {
	...
	xmlHttp.open("POST", "/UniNote/ChangeUserInfoServlet", true);
	// post方式需要自己设置http的请求头
	xmlHttp.setRequestHeader("Content-Type",
			"application/x-www-form-urlencoded");
	// post方式发送数据
	xmlHttp.send("flag=" + flag+"&nickname="+nickname+"&email="+email+"&school="+school+"&phonenumber="+phonenumber);
	// 4.发送数据，开始和服务器端进行交互
